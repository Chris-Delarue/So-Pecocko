...
//Multer est un middleware qui nous permet de traiter les téléchargements de fichiers avec notre application Express.
const multer = require('multer');
// création d'une structure MIME pour indiquer les formats d'image dans un objet
const MIME_TYPES = {
  'image/jpg': 'jpg',
  'image/jpeg': 'jpg',
  'image/png': 'png'
};
//nous créons une constante storage , qui contient la logique nécessaire pour indiquer à multer où enregistrer les fichiers entrants
